...
export async function GET(request: NextRequest) {
  try {
    ...
    const totalWhatsAppRevoked = membersWhatsAppRevoked + eventRegsWithoutWhatsApp;
    ...
    const stats = {
      ...
      members: {
        ...
        whatsapp: {
          ...
          percentage: totalActiveMembers > 0 
      ...
      event_registrations: {
        ...
        whatsapp: {
          ...
          percentage: totalEventRegistrations > 0 
            ? Math.round((eventRegsWithWhatsApp / totalEventRegistrations) * 100) 
            : 0
        }
      },
