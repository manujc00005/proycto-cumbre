        ...
        <div className="flex-1 overflow-y-auto">
          {items.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full px-6 text-center">
              <ShoppingBag className="w-16 h-16 text-zinc-300 mb-4" strokeWidth={1.5} />
              <p className="text-zinc-900 font-medium text-lg mb-2">Your bag is empty</p>
                ...
                >
                  <div className="flex gap-4 p-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {item.variant && (
                        <p className="text-xs text-zinc-600 mt-1">{item.variant}</p>
                      )}

                      {item.size && (
                        <p className="text-xs text-zinc-600 mt-0.5">
                          One Size: <span className="font-medium">{item.size}</span>
                        </p>
                      )}
                      ...
                      <div className="flex items-center justify-between mt-3">
                        ...
                        <div className="flex items-center border border-zinc-300 rounded">
                          ...
                          >
                            <Minus className="w-3 h-3 text-zinc-900" strokeWidth={2} />
                          </button>
                          ...
                          >
                            <Plus className="w-3 h-3 text-zinc-900" strokeWidth={2} />
                          </button>
                        </div>
          ...
          <div className="bg-white border-t border-zinc-200 p-4 md:p-6">
            ...
            <div className="bg-zinc-100 rounded-lg p-3 mb-4">
              <div className="flex justify-between items-center text-sm">
                <span className="text-zinc-700">Complete for free delivery</span>
            ...
            <div className="space-y-2 mb-4 text-sm">
              <div className="flex justify-between">
                ...
                <span className="text-zinc-900">{total >= 140 ? '0' : DELIVERY_FEE} EUR</span>
              </div>
              <div className="flex justify-between">
                <span className="text-zinc-700">Subtotal</span>
                <span className="text-zinc-900 font-medium">{total.toFixed(2)} EUR</span>
              </div>
            </div>
