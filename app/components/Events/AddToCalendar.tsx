  ...
  return (
    <div className={`relative ml-auto ${className}`}>
      ...
      >
        ...
        >
          <svg className="w-4 h-4 sm:w-5 sm:h-5 text-blue-400 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
        ...
        <a 
          ...
          onClick={closeDropdown}
        >
          <svg className="w-4 h-4 sm:w-5 sm:h-5 text-zinc-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
          </svg>
