...
import { IconType, EventColor, ICON_COLOR_CLASSES } from '@/lib/events-constants';
...
const EventIcon: React.FC<EventIconProps> = ({ type, color = 'orange' }) => {
  ...
  const icons: Record<IconType, JSX.Element> = {
    ...
    bike: (
      <svg className={`w-12 h-12 ${colorClass}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M5 19a4 4 0 100-8 4 4 0 000 8zm14 0a4 4 0 100-8 4 4 0 000 8zM8.5 8.5l2-3 1.5 1 3-3M12 14l-4 5m7-5l1.5-4.5" />
      </svg>
    ),
    volleyball: (
      <svg className={`w-12 h-12 ${colorClass}`} fill="currentColor" viewBox="0 0 24 24">
    ...
    beach: (
      <svg className={`w-12 h-12 ${colorClass}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 17h18M5 21h14M7 13l3-3 3 3 3-3M12 3v7m0 0l-3-3m3 3l3-3" />
