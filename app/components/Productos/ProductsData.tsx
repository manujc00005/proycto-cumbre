export const productsData = [
  {
    ...
    price: 25,
    images: ["/shop/sierra_back.jpg", "/shop/Sierra_front.jpg"],
    sizes: ["S", "M", "L", "XL"],
    tags: ["NEW", "LIMITED"],
  },
  {
    ...
    price: 50,
    images: ["/shop/diabli_back.jpg", "/shop/diablo_front.jpg"],
    sizes: ["S", "M", "L", "XL"],
    tags: ["BESTSELLER"],
  },
  {
    ...
    price: 20,
    images: ["/shop/classic_back.jpg", "/shop/classic_front.jpg"],
    sizes: ["S", "M", "L", "XL"],
    tags: [],
  },
  {
  ...
  },
  {
    ...
    price: 40,
    images: ["/shop/competición_back.jpg", "/shop/competición_front.jpg"],
    sizes: ["S", "M", "L", "XL"],
    tags: ["PERFORMANCE"],
  },
  {
    ...
    price: 25,
    images: ["/shop/entrenamiento_back.jpg", "/shop/entrenamiento_front.jpg"],
    sizes: ["S", "M", "L", "XL"],
    tags: ["TRAINING"],
  },
  {
