...
export function ClubCommsDisclosure({
  ...
  const title =
    variant === 'club' ? 'Comunicaciones del club' : 'Comunicaciones sobre eventos';
      ...
      {variant === 'club' ? (
        <>
          ...
          <p className="text-blue-400 text-xs leading-relaxed">
            <strong className="text-blue-300">Base legal:</strong> Interés legítimo del club en mantener informados a sus socios.
        ...
        <>
          ...
          <p className="text-blue-400 text-xs leading-relaxed mb-2">
            <strong className="text-blue-300">Base legal:</strong> Ejecución del contrato (este evento) e interés legítimo del club
            para informarte sobre actividades relacionadas.
          </p>
          <p className="text-blue-400 text-xs leading-relaxed">
