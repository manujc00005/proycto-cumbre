...
// Componente GDPR específico para eventos (MISA, etc)
// - Detecta automáticamente si el usuario es socio
// - Desplegable informativo adaptado
// - WhatsApp obligatorio con email incluido
...
export default function GDPRConsentEvent({ 
  ...
  const handlePrivacyChange = (checked: boolean) => {
    ...
    onConsentChange?.({ privacyPolicy: checked, whatsapp });
  };

  const handleWhatsappChange = (checked: boolean) => {
    setWhatsapp(checked);
    onConsentChange?.({ privacyPolicy, whatsapp: checked });
  };
        ...
        >
          ...
          <div className="flex-1">
            <p className="text-blue-300 font-semibold text-sm mb-1">
              ℹ️ Comunicaciones sobre eventos
            </p>
            ...
            {isMember ? (
              ...
              <>
                <p className="text-blue-200/80 text-xs leading-relaxed mb-3">
                  Como socio del club, recibirás comunicaciones por email sobre eventos, actividades, 
                  salidas programadas y novedades del club. Esto nos permite mantener a todos los socios 
                  informados y facilitar su participación activa.
                </p>
              ...
              // Texto para NO SOCIOS
              <>
                <p className="text-blue-200/80 text-xs leading-relaxed mb-3">
                  Al inscribirte a este evento, podrás recibir comunicaciones relacionadas con la actividad 
                  (confirmaciones, actualizaciones, información logística). También te informaremos sobre 
                  eventos futuros similares que puedan interesarte.
                </p>
                <p className="text-blue-300/70 text-xs leading-relaxed mb-2">
                  <strong className="text-blue-300">Base legal:</strong> Ejecución del contrato (este evento) 
                  e interés legítimo del club para informarte sobre actividades relacionadas.
                </p>
                <p className="text-blue-300/70 text-xs leading-relaxed">
      ...
      <label className="flex items-start gap-3 cursor-pointer group">
        ...
        <div className="flex-1">
          <span className="text-sm text-white/80 leading-relaxed block">
            Acepto que mis datos de contacto (<strong>nombre, email y teléfono</strong>) sean compartidos 
            en los grupos de WhatsApp del club
            <span className="text-orange-400 ml-1">*</span>
          </span>
          ...
          <div className="mt-2 p-2 bg-yellow-500/10 border border-yellow-500/30 rounded text-xs text-yellow-300/90 flex items-start gap-2">
            ...
            <span>
              WhatsApp es el canal principal del club. Sin este consentimiento, no recibirás avisos 
              de actividades, fotos de salidas ni comunicaciones urgentes.
            </span>
          </div>
        </div>
      </label>
