...
export default function RGPDTableUnified() {
  ...
  const handleRevokeConsent = async (
    userId: string,
    email: string,
    consentType: "whatsapp" | "marketing",
  ) => {
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-yellow-200/80">
                Las acciones de revocación y soft delete son permanentes. Usa
                estas funciones solo cuando sea necesario por cumplimiento RGPD
                o solicitud del usuario.
              </p>
            </div>
          </div>
        </div>
        ...
        {stats && (
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            ...
            <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-4">
              ...
              <div className="text-xs text-orange-300 uppercase">
                Solo eventos
              </div>
            </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-zinc-800">
              <tr>
                <th className="px-6 py-4 text-left text-xs font-bold text-zinc-400 uppercase">
                  Nombre
                </th>
                <th className="px-6 py-4 text-left text-xs font-bold text-zinc-400 uppercase">
                  Email
                ...
                <th className="px-6 py-4 text-center text-xs font-bold text-zinc-400 uppercase">
                  WhatsApp
                </th>
                <th className="px-6 py-4 text-center text-xs font-bold text-zinc-400 uppercase">
                  Marketing
                </th>
                <th className="px-6 py-4 text-right text-xs font-bold text-zinc-400 uppercase">
                  Acciones
                </th>
              </tr>
            </thead>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      {user.type !== "event_only" && (
                        <button
                          onClick={() =>
                            handleDeleteConsent(user.id, user.email)
                          }
