            ...
            <div className="bg-zinc-800/50 rounded-xl p-6 mb-6 animate-in fade-in duration-500 delay-300">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between items-start gap-4">
                  ...
                  <span className="text-zinc-300 text-right break-all">
                    {paymentData.email}
                  </span>
                </div>
                <div className="flex justify-between items-start gap-4">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3 text-sm">
                ...
                <div>
                  <p className="text-zinc-300">
                    Únete al{" "}
                    <strong className="text-white">grupo de WhatsApp</strong>{" "}
              ...
              <li className="flex items-start gap-3 text-sm">
                ...
                <div>
                  <p className="text-zinc-300">
                    <strong className="text-white">Coordenadas secretas</strong>{" "}
                    se revelarán 2h antes del evento
                  </p>
                </div>
              </li>
              ...
              <li className="flex items-start gap-3 text-sm">
                ...
                <div>
                  <p className="text-zinc-300">
                    El <strong className="text-white">track GPS</strong> se
                    compartirá 1h antes
                  </p>
                </div>
              </li>
        ...
        <div className="bg-orange-500/10 border border-orange-500/30 rounded-xl p-4 mb-6 flex gap-3">
          ...
          <div className="text-sm">
            ...
            <p className="text-orange-400/90 text-xs leading-relaxed">
              Este es un evento exclusivo de trail running nocturno. Las
              coordenadas exactas se revelarán 2 horas antes por seguridad.
              Prepara tu frontal, zapatillas de trail y ropa técnica.
            </p>
          </div>
        </div>
