        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
           ...
           <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Link
              href="/membership"
              className="bg-gradient-to-r from-orange-600 to-orange-500 hover:from-orange-500 hover:to-orange-600 text-white px-8 py-4 rounded-lg font-bold transition shadow-xl shadow-orange-500/30 hover:scale-105 inline-flex items-center gap-3 border-2 border-orange-400"
            >
            ...
            <a 
              ...
              className="bg-green-600 hover:bg-green-500 text-white px-8 py-4 rounded-lg font-semibold transition shadow-lg inline-flex items-center gap-3"
            >
            ...
            {/* CTA TERCIARIO - Ver Aventuras */}
            <a 
              href="#aventuras" 
              className="text-orange-400 hover:text-orange-300 px-8 py-4 font-semibold transition flex items-center justify-center border border-orange-400 hover:border-orange-300 rounded-lg"
            >
              Ver Aventuras →
            </a>
          </div>
