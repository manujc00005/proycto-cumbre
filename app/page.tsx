...
export default function Home() {
  ...
  return (
    <div className="bg-zinc-950 text-white min-h-screen">
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="md:hidden space-y-6">
              ...
              <div className="space-y-3 pt-2">
                <Link
                  href="/membership"
                  className="w-full py-4 bg-white text-black hover:bg-zinc-100 rounded-full font-bold text-base transition-all shadow-xl flex items-center justify-center gap-2"
                >
                ...
                <a
                  ...
                  className="w-full py-4 border-2 border-white text-white hover:bg-white hover:text-black rounded-full font-semibold text-base transition-all flex items-center justify-center gap-2"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
              ...
              <div className="space-y-5">
                ...
                <div className="space-y-4 max-w-xl">
                  <p className="text-sm lg:text-base text-zinc-100 leading-relaxed">
                    Somos ese club que nació sudados, hambrientos y doloridos… y
                    que terminó fundándose en un antro cualquiera después de una
                    ruta. Nada épico, nada místico. Solo montaña, cerveza
                    caliente y la brillante idea de crear un club del que ni
                    nosotros mismos nos fiaríamos demasiado.
                  </p>

                  <p className="text-sm lg:text-base text-zinc-100 leading-relaxed">
                    Si buscas postureo… sí, también hay. Y si buscas éxito
                    deportivo, gloria o disciplina militar, este no es tu sitio.
                    Aquí venimos a explorar, a ensuciarnos, a perdernos un poco
                    y a juntarnos con gente que está igual de tocada por la
                    montaña que tú.
                  </p>

                  <p className="text-sm lg:text-base text-orange-400 font-bold leading-relaxed">
                    Bienvenido a Proyecto Cumbre: un club de montaña
                    impresentable, pero auténtico.
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-3 max-w-md">
                  <Link
                    href="/membership"
                    className="group relative overflow-hidden bg-gradient-to-r from-orange-600 via-orange-500 to-orange-600 text-white px-8 py-3.5 rounded-2xl font-bold text-base shadow-2xl hover:scale-[1.02] border-2 border-orange-400/50 flex items-center justify-center gap-3 transition-all"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-green-600/95 hover:bg-green-500 text-white px-8 py-3.5 rounded-2xl font-bold text-base shadow-xl hover:scale-[1.02] border border-green-500/50 flex items-center justify-center gap-3 transition-all"
                  >
                    <svg
                      className="w-5 h-5"
                      fill="currentColor"
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 md:items-start">
            ...
            <div className="space-y-6 ">
              <p className="text-base md:text-lg text-zinc-300 leading-relaxed">
                Proyecto Cumbre nació como nacen las mejores (y peores) ideas:
                reventados, oliendo a cabra y sentados en un bar cutre después
                de una ruta demasiado larga. Entre sudor, barro y promesas que
                no deberíamos haber hecho, decidimos montar un club de montaña.
                No porque el mundo lo pidiera, sino porque nosotros sí.{" "}
              </p>
              <p className="text-base md:text-lg text-zinc-300 leading-relaxed">
                Somos un grupo que no comparte cordura, pero sí un lugar común:
                el campo. Y desde aquel día se ha sumado más gente como
                nosotros: amantes del desnivel y ciudadanos medianamente
                funcionales de lunes a viernes.{" "}
              </p>
              <p className="text-base md:text-lg text-zinc-300 leading-relaxed">
                No vendemos un estilo de vida perfecto. Aquí hay postureo, fotos
                mal hechas, rutas que se nos van de las manos, grupos de
                WhatsApp imposibles de controlar, y una disciplina bastante
                cuestionable.{" "}
              </p>
              <p className="text-base md:text-lg text-zinc-300 leading-relaxed">
                Pero también hay algo serio: la comunidad. Una comunidad que
                sale al monte para respirar, desconectar, buscar terreno nuevo y
                pasar más horas afuera que frente a una pantalla. Gente que sabe
                que explorar es mejor que competir y que la montaña enseña más
                que cualquier documental de la 2.
              </p>
              <p className="text-base md:text-lg text-zinc-300 leading-relaxed">
                No prometemos medallas ni transformaciones mágicas. Prometemos
                esto:
              </p>
              ...
              <p className="text-base md:text-lg text-zinc-300 leading-relaxed">
                Proyecto Cumbre: el club que no debería existir, pero existe. Y
                cada día somos más.{" "}
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-lg md:text-xl text-zinc-300 max-w-3xl mx-auto leading-relaxed">
              Casi un año haciendo{" "}
              <strong className="text-orange-400">
                los perlas por el monte
              </strong>
              . Para 2026 ya podéis apuntaros y federaros en montaña con el club
              que de verdad os entiende.
            </p>
            <div className="mt-4 space-y-2 flex flex-col items-center text-center">
              <p className="text-zinc-400 text-sm md:text-base">
                <strong className="text-white">
                  Inscripciones abiertas desde diciembre.
                </strong>
              </p>
              <div className="flex items-center gap-2">
                <svg
                ...
                <div className="space-y-4 mb-8 flex-1">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-white font-semibold text-sm">
                        Licencia Federativa FEDME
                      </p>
                      <p className="text-zinc-400 text-xs">
                        Seguro de accidentes en montaña + cobertura rescate
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-zinc-400 text-xs">
                        Camiseta técnica + gorra oficial del club
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-zinc-400 text-xs">
                        Inscripción preferente en todas las aventuras
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-zinc-400 text-xs">
                        10-20% en merchandise y eventos especiales
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-zinc-400 text-xs">
                        Grupo privado de WhatsApp con planificación anticipada
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-zinc-400 text-xs">
                        Talleres y entrenamientos exclusivos para socios
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-gradient-to-br from-zinc-900 to-zinc-950 rounded-2xl p-8 border border-zinc-700 hover:border-zinc-600 transition-all shadow-xl h-full flex flex-col">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-yellow-200 text-xs leading-relaxed">
                        Algunas actividades del club requieren seguro de montaña
                        obligatorio (alta montaña, vivacs, rutas técnicas). Sin
                        licencia FEDME, deberás contratar tu propio seguro para
                        participar en estas aventuras.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4 mb-8 flex-1">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-zinc-400 text-xs">
                        Inscripción preferente (si cumples requisitos de seguro)
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="pt-4 border-t border-zinc-800">
                    ...
                    <div className="flex items-start gap-3 opacity-50 mb-2">
                      ...
                      <div>
                        ...
                        <p className="text-zinc-600 text-xs">
                          Deberás gestionarla por tu cuenta
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 opacity-50">
                      ...
                      <div>
                        ...
                        <p className="text-zinc-600 text-xs">
                          Seguro propio obligatorio para actividades técnicas
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="mt-auto">
                  ...
                  <p className="text-xs text-zinc-500 text-center">
                    *Acceso limitado a algunas actividades técnicas sin seguro
                    propio
                  </p>
                </div>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-zinc-900/50 backdrop-blur-sm rounded-xl p-6 md:p-8 border border-zinc-800 mb-8">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-zinc-300 text-sm leading-relaxed mb-4">
                    ...
                    te proporciona un seguro de accidentes deportivos, cobertura
                    de rescate en montaña y acceso a refugios federados con
                    descuentos.
                  </p>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4 mt-4">
                <p className="text-xs text-blue-300">
                  <strong>💡 Modalidades disponibles:</strong> Montañismo,
                  Escalada, Senderismo, Trail Running, Esquí de Montaña. El
                  precio varía según la modalidad elegida (desde 30€ hasta 60€
                  aproximadamente).
                </p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-orange-500/10 via-orange-500/5 to-transparent rounded-xl p-8 border border-orange-500/30 text-center">
              ...
              <p className="text-zinc-300 mb-6 max-w-2xl mx-auto">
                Únete a la familia Proyecto Cumbre y vive las mejores aventuras
                con gente que comparte tu pasión por la montaña.
              </p>
            ...
            <div className="mt-8 flex items-center justify-center gap-4 flex-wrap text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-zinc-400">
                  <strong className="text-white">Inscripciones abiertas</strong>{" "}
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-zinc-400">
                  Temporada 2026 empieza en{" "}
                  <strong className="text-white">enero</strong>
                </span>
              </div>
            </div>
          </div>
      ...
      <section id="aventuras" className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          <p className="text-zinc-400 mb-8 md:mb-12">
            Algunos de los proyectos que organizamos dentro del club.
          </p>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-zinc-800/50 p-4 rounded-lg border border-zinc-700/50">
                  <p className="text-sm md:text-base text-zinc-300 leading-relaxed">
                    ...
                    recorriendo todos los refugios oficiales en una travesía de{" "}
                    <strong className="text-orange-400">4 días</strong> que
                    enlaza los tres macizos y algunos de los paisajes más
                    icónicos del parque. Una ruta exigente, técnica y de gran
                    belleza, perfecta para quienes disfrutan de largas jornadas,
                    fuertes desniveles y pasos de alta montaña.
                  </p>
                </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs md:text-sm text-zinc-400 leading-relaxed">
                          Poncebos → Camino del Cares → Canal de Trea → Refugio
                          Vega de Ario → Refugio Vegarredonda
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="group bg-zinc-800/30 hover:bg-zinc-800/60 p-4 rounded-xl border border-zinc-700/50 hover:border-orange-500/50 transition-all duration-300">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs md:text-sm text-zinc-400 leading-relaxed">
                          Refugio Vegarredonda → Torre de Santa María → Refugio
                          Vegabaño → Posada de Valdeón → Canal de Asotín →
                          Collado Jermoso → Refugio Collado Jermoso
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="group bg-zinc-800/30 hover:bg-zinc-800/60 p-4 rounded-xl border border-zinc-700/50 hover:border-orange-500/50 transition-all duration-300">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs md:text-sm text-zinc-400 leading-relaxed">
                          Refugio Collado Jermoso → Cabaña Verónica → Casetón de
                          Ándara → Canal de Jidiellu → Sotres → Refugio Terenosa
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="group bg-zinc-800/30 hover:bg-zinc-800/60 p-4 rounded-xl border border-zinc-700/50 hover:border-orange-500/50 transition-all duration-300">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs md:text-sm text-zinc-400 leading-relaxed">
                          Refugio Terenosa → Refugio Vega de Urriellu → Refugio
                          Jou de los Cabrones → Bulnes → Poncebos
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div className="bg-gradient-to-br from-zinc-900 to-zinc-950 rounded-2xl p-6 md:p-8 border border-zinc-800 hover:border-orange-500/50 transition-all duration-300 shadow-xl">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-zinc-800/50 p-4 rounded-lg border border-zinc-700/50">
                  <p className="text-sm md:text-base text-zinc-300 leading-relaxed">
                    Realizamos una travesía de{" "}
                    <strong className="text-orange-400">3 días</strong> por las
                    alturas de Sierra Nevada, combinando{" "}
                    <strong className="text-green-400">
                      vivac bajo las estrellas
                    </strong>{" "}
                    y pernocta en refugios según disponibilidad. Una ruta
                    perfecta para quienes buscan desnivel, ascensiones
                    opcionales y la experiencia de moverse por uno de los
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <div className="flex flex-wrap items-center gap-2 mb-2">
                          ...
                          <span className="px-2 py-0.5 bg-zinc-600/50 text-zinc-300 text-xs rounded">
                            3–4 h
                          </span>
                        </div>
                ...
                <div className="bg-gradient-to-r from-orange-500/10 to-transparent p-4 rounded-lg border-l-4 border-orange-500">
                  <p className="text-sm text-zinc-300 leading-relaxed italic">
                    Una experiencia completa por la alta montaña granadina, con
                    amaneceres inolvidables, cumbres míticas y la libertad del
                    vivac en altura.
                  </p>
                </div>
      ...
      <section
        id="contact"
        className="py-16 md:py-24 bg-zinc-900/50 relative overflow-hidden"
      >
        {/* Efectos de fondo */}
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-zinc-400 max-w-2xl mx-auto">
              ¿Tienes alguna pregunta? ¿Quieres unirte al club? ¿Necesitas más
              información sobre nuestras aventuras?
              <br />
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-orange-200/80 text-xs">
                      Normalmente respondemos en menos de 24 horas. Si es
                      urgente, contacta por WhatsApp.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-1">
              <div className="mb-6">
                ...
                <p className="text-zinc-400 text-sm leading-relaxed">
                  Club de montaña para los que prefieren el barro antes que el
                  sofá.
                </p>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a
                    href="#inicio"
                    className="text-zinc-400 hover:text-orange-400 transition flex items-center gap-2 group"
                  >
                    <svg
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <svg
                    className="w-5 h-5 text-zinc-600 group-hover:text-pink-400 group-hover:translate-x-1 transition-all"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
