...
export const metadata: Metadata = {
  ...
  description:
    "Política de Privacidad y Protección de Datos de Proyecto Cumbre",
};
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-invert prose-zinc max-w-none">
          ...
          <section className="mb-12 bg-zinc-900 rounded-xl p-8 border border-zinc-800">
            ...
            <div className="space-y-4 text-zinc-300">
              <p className="leading-relaxed">
                ...
                tratamiento de datos personales (RGPD), te informamos:
              </p>

              <div className="bg-zinc-800/50 rounded-lg p-6 space-y-2">
                <p>
                  <strong className="text-white">Responsable:</strong>{" "}
            ...
            <div className="space-y-4 text-zinc-300">
              ...
              <div className="space-y-4">
                <div className="bg-zinc-800/50 rounded-lg p-4">
                  ...
                  <p className="text-sm">
                    Alta como socio del club, renovación anual y gestión
                    administrativa de la membresía.
                  </p>
                </div>

                <div className="bg-zinc-800/50 rounded-lg p-4">
                  <h3 className="text-white font-bold mb-2">
                    🏔️ Inscripción a eventos deportivos
                  </h3>
                  <p className="text-sm">
                    Gestión de inscripciones a actividades como MISA, rutas,
                    salidas de montaña y otros eventos organizados por el club.
                  </p>
                </div>

                <div className="bg-zinc-800/50 rounded-lg p-4">
                  <h3 className="text-white font-bold mb-2">
                    🎫 Tramitación de licencias FEDME
                  </h3>
                  <p className="text-sm">
                    Gestión de licencias federativas con la Federación Española
                    de Deportes de Montaña y Escalada, incluyendo el envío de tu
                    información personal y certificado médico (si procede).
                  </p>
                </div>
                ...
                <div className="bg-zinc-800/50 rounded-lg p-4">
                  ...
                  <p className="text-sm">
                    Procesamiento de cuotas de socio, inscripciones a eventos y
                    venta de merchandising mediante pasarela de pago Stripe.
                  </p>
                </div>
                ...
                <div className="bg-zinc-800/50 rounded-lg p-4">
                  ...
                  <ul className="text-sm space-y-1 ml-4 list-disc list-inside mb-3">
                    ...
                    <li>
                      Información relevante para socios (asambleas, cambios en
                      estatutos, etc.)
                    </li>
                  ...
                  <div className="bg-blue-500/10 border-l-4 border-blue-400 p-3 rounded mt-3">
                    <p className="text-xs text-blue-300">
                      <strong>Nuestro interés legítimo:</strong> Facilitar la
                      participación activa de los socios en las actividades del
                      club y garantizar el buen funcionamiento de nuestra
                      comunidad deportiva. La comunicación fluida con nuestros
                      socios es esencial para cumplir los fines asociativos del
                      club.
                    </p>
                    <p className="text-xs text-blue-300 mt-2">
                      <strong>Tu derecho de oposición:</strong> Puedes oponerte
                      ...
                      , aunque esto podría limitar tu participación activa en el
                      club.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-zinc-800/50 rounded-lg p-4">
                  ...
                  <p className="text-sm mb-3">
                    Si nos das tu consentimiento explícito (checkbox opcional en
                    el formulario), también podremos enviarte:
                  </p>
                  <ul className="text-sm space-y-1 ml-4 list-disc list-inside mb-3">
                    <li>
                      Ofertas especiales en productos del club (merchandising)
                    </li>
                  ...
                  <div className="bg-green-500/10 border-l-4 border-green-400 p-3 rounded mt-3">
                    <p className="text-xs text-green-300">
                      Este consentimiento es{" "}
                      <strong>completamente opcional</strong> y no afecta a tu
                      membresía del club. Puedes darlo o retirarlo en cualquier
                      momento utilizando el enlace de "darme de baja" en cada
                      email o escribiendo a privacidad@proyecto-cumbre.es
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-zinc-800/50 rounded-lg p-4">
                  ...
                  <p className="text-sm">
                    Compartir tu nombre y teléfono con otros socios del club en
                    grupos de WhatsApp para la gestión y coordinación de
                    actividades (solo si diste tu consentimiento explícito en el
                ...
                <div className="bg-zinc-800/50 rounded-lg p-4">
                  ...
                  <p className="text-sm">
                    Gestión de pedidos de merchandising oficial, envío de
              ...
              <ul className="space-y-3 list-none">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    ...
                    Gestión de tu membresía, inscripciones a eventos y
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    ...
                    Comunicaciones comerciales opcionales, grupos de WhatsApp y
                    tratamiento de datos de salud (certificados médicos para
                    licencias FEDME).
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-orange-500 font-bold">✓</span>
                  <span>
                    <strong className="text-white">Obligación legal:</strong>{" "}
                    Conservación de datos fiscales y contables durante 10 años
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    ...
                    Comunicaciones informativas del club con socios, mejora de
                    nuestros servicios y seguridad de las actividades
                    deportivas.
                  </span>
                </li>
              </ul>
            ...
            <div className="space-y-6 text-zinc-300">
              <div>
                ...
                <p className="text-sm bg-zinc-800/30 p-3 rounded">
                  Nombre, apellidos, DNI/NIE, fecha de nacimiento, sexo,
                  fotografía (si la proporcionas).
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm bg-zinc-800/30 p-3 rounded">
                  Email, teléfono, dirección postal, ciudad, provincia, código
                  postal.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm bg-zinc-800/30 p-3 rounded mb-2">
                  Tallas de ropa (camiseta, sudadera, pantalón), certificado
                  médico-deportivo (solo para tramitación de licencias
                  federativas que lo requieran).
                </p>
                <div className="bg-orange-500/10 border-l-4 border-orange-500 p-4 rounded">
                  <p className="text-sm text-orange-300">
                    <strong>⚠️ Importante:</strong> El tratamiento de datos de
                    salud requiere tu consentimiento explícito. Tu certificado
                    médico será compartido únicamente con FEDME para la
                    tramitación de tu licencia federativa.
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-sm bg-zinc-800/30 p-3 rounded">
                  Información de tarjeta bancaria (procesada directamente por
                  Stripe, nunca almacenamos tus datos bancarios completos).
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm bg-zinc-800/30 p-3 rounded">
                  Dirección IP, tipo de navegador, páginas visitadas, cookies
                  técnicas necesarias para el funcionamiento del sitio web.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12 bg-zinc-900 rounded-xl p-8 border border-zinc-800">
            ...
            <div className="space-y-4 text-zinc-300">
              ...
              <div className="space-y-3">
                <div className="bg-zinc-800/50 rounded-lg p-4">
                  <h3 className="text-white font-bold mb-2">
                    🏔️ FEDME (Federación Española de Deportes de Montaña)
                  </h3>
                  <p className="text-sm">
                    Para tramitación de licencias federativas. Compartimos:
                    nombre, apellidos, DNI, fecha de nacimiento, sexo,
                    dirección, certificado médico (si procede).
                  </p>
                </div>
                ...
                <div className="bg-zinc-800/50 rounded-lg p-4">
                  ...
                  <p className="text-sm">
                    Cumple con PCI-DSS para garantizar la seguridad de tus datos
                    bancarios.{" "}
                    <a
                ...
                <div className="bg-zinc-800/50 rounded-lg p-4">
                  <h3 className="text-white font-bold mb-2">
                    📧 Resend (Plataforma de envío de emails)
                  </h3>
                  <p className="text-sm">
                    Para enviar confirmaciones de registro, emails
                    transaccionales y comunicaciones del club.
                  </p>
                </div>
                ...
                <div className="bg-zinc-800/50 rounded-lg p-4">
                  ...
                  <p className="text-sm">
                    Otros participantes del mismo evento podrán ver tu nombre y
                    teléfono en grupos de WhatsApp (solo si diste tu
                    consentimiento).
                  </p>
                </div>
                ...
                <div className="bg-zinc-800/50 rounded-lg p-4">
                  ...
                  <p className="text-sm">
                    Para el envío de merchandising: nombre, dirección de envío.
                  </p>
                </div>
                ...
                <div className="bg-zinc-800/50 rounded-lg p-4">
                  ...
                  <p className="text-sm">
                    Cuando sea legalmente obligatorio (Agencia Tributaria,
                    juzgados, etc.).
                  </p>
                </div>
              </div>
          ...
          <section className="mb-12 bg-zinc-900 rounded-xl p-8 border border-zinc-800">
            ...
            <div className="space-y-4 text-zinc-300">
              ...
              <div className="bg-zinc-800/50 rounded-lg p-4">
                <p className="mb-2">
                  <strong className="text-white">
                    Stripe y Resend (Estados Unidos):
                  </strong>
                </p>
                <p className="text-sm">
                  Transferencias protegidas mediante el{" "}
                  <strong className="text-orange-500">
                    Data Privacy Framework (DPF)
                  </strong>{" "}
                  EU-US, reconocido por la Comisión Europea como mecanismo
                  ...
                  <tbody className="divide-y divide-zinc-800">
                    <tr>
                      ...
                      <td className="py-3 px-4">
                        Mientras dure tu membresía + 1 año adicional
                      </td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4">Datos fiscales/contables</td>
                      <td className="py-3 px-4">
                        10 años (obligación legal tributaria)
                      </td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4">Inscripciones a eventos</td>
                      <td className="py-3 px-4">
                        3 meses tras el evento (salvo datos fiscales)
                      </td>
                    </tr>
                    <tr>
          ...
          <section className="mb-12 bg-gradient-to-br from-orange-500/10 to-orange-500/5 rounded-xl p-8 border-2 border-orange-500/30">
            ...
            <div className="space-y-4 text-zinc-300">
              <p className="leading-relaxed text-white font-medium">
                Tienes derecho a ejercer los siguientes derechos en cualquier
                momento:
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-zinc-900/50 rounded-lg p-4 border border-zinc-800">
                  ...
                  <p className="text-sm">
                    Obtener información sobre qué datos personales tuyos estamos
                    tratando.
                  </p>
                </div>
                ...
                <div className="bg-zinc-900/50 rounded-lg p-4 border border-zinc-800">
                  ...
                  <p className="text-sm">
                    Solicitar que se restrinja el tratamiento en determinados
                    casos.
                  </p>
                </div>
                ...
                <div className="bg-zinc-900/50 rounded-lg p-4 border border-zinc-800">
                  ...
                  <p className="text-sm">
                    Recibir tus datos en formato estructurado y transmitirlos a
                    otro responsable.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-blue-500/10 border-l-4 border-blue-400 p-6 rounded mt-6">
                <h3 className="text-white font-bold mb-3">
                  🔒 Derecho de oposición específico (Art. 21 RGPD)
                </h3>
                <p className="text-sm mb-3">
                  Si nos basamos en el{" "}
                  <strong className="text-blue-300">
                    interés legítimo del club
                  </strong>{" "}
                  para enviarte comunicaciones informativas (como avisos de
                  eventos y actividades), tienes derecho a oponerte a este
                ...
                <p className="text-sm text-blue-200">
                  Ten en cuenta que ejercer este derecho puede limitar tu
                  participación activa en el club, ya que no recibirás
                  información sobre eventos y salidas programadas.
                </p>
              </div>
              ...
              <div className="bg-orange-500/10 border-l-4 border-orange-500 p-6 rounded mt-6">
                ...
                <p className="text-sm mt-4">
                  <strong className="text-white">Plazo de respuesta:</strong> 1
                  mes desde la recepción de tu solicitud.
                </p>
              </div>
              ...
              <div className="bg-zinc-900/50 border border-zinc-700 p-6 rounded mt-4">
                ...
                <p className="text-sm mb-2">
                  ...
                  normativa, puedes presentar una reclamación ante:
                </p>
            ...
            <div className="space-y-4 text-zinc-300">
              ...
              <ul className="space-y-3 list-none">
                ...
                <li className="flex items-start gap-3">
                  <span className="text-orange-500 text-xl">👥</span>
                  <span>
                    Acceso restringido a datos personales solo al personal
                    autorizado
                  </span>
                </li>
                <li className="flex items-start gap-3">
              ...
              <p className="text-sm mt-4 bg-zinc-800/30 p-4 rounded">
                A pesar de implementar estas medidas, ningún sistema es 100%
                seguro. En caso de brecha de seguridad que suponga un riesgo
                para tus derechos, te notificaremos en un plazo máximo de 72
                horas.
              </p>
            </div>
          </section>
          ...
          <section className="mb-12 bg-zinc-900 rounded-xl p-8 border border-zinc-800">
            ...
            <div className="space-y-4 text-zinc-300">
              <p className="leading-relaxed">
                Para darte de alta como socio debes tener al menos{" "}
                <strong className="text-white">14 años</strong>.
              </p>

              <div className="bg-orange-500/10 border-l-4 border-orange-500 p-4 rounded">
                <p className="text-sm text-orange-300">
                  <strong>⚠️ Menores de 18 años:</strong> Si eres menor de 18
                  años, necesitas el consentimiento de tus padres o tutores
                  legales. Al registrarte, declaras contar con dicha
                  autorización.
                </p>
              </div>
            </div>
          ...
          <section className="mb-12 bg-zinc-900 rounded-xl p-8 border border-zinc-800">
            ...
            <div className="space-y-4 text-zinc-300">
              <p className="leading-relaxed">
                ...
                Privacidad para adaptarla a cambios legislativos o en nuestros
                servicios.
              </p>

              <p className="leading-relaxed">
                Te notificaremos cualquier cambio sustancial por email o
                mediante aviso destacado en la web.
              </p>
          ...
          <section className="bg-gradient-to-br from-orange-500/10 to-orange-500/5 rounded-xl p-8 border-2 border-orange-500/30">
            ...
            <div className="space-y-4 text-zinc-300">
              <p className="leading-relaxed">
                Para cualquier duda sobre esta Política de Privacidad o el
