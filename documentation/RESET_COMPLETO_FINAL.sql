-- ============================================
-- PROYECTO CUMBRE - RESET COMPLETO
...
-- ✅ 5 Enums (Sex, LicenseType, FedmeStatus, MembershipStatus, PaymentStatus)
...
-- ✅ 4 Vistas (members_list, active_members, pending_members, expiring_soon)
-- ✅ 1 Sede por defecto (Málaga)

-- Tu base de datos está lista para usar! 🏔️
INSERT INTO headquarters (
  id,
  name,
  code,
  ...
  gen_random_uuid(),
  'Sede Málaga',  -- 👈 Confirma el nombre
  'MAL',
  'Málaga',
  NULL,  -- 👈 Añade teléfono si lo tienes
  NULL,  -- 👈 Añade email si lo tienes
  '{"basic": 50, "premium": 80, "family": 120}'::jsonb,  -- 👈 Confirma precios
  'active',
  NOW(),
  NOW()
);