...
export const TERRITORIES: LicenseTerritory[] = [
  {
    ...
    shortName: "Andalucía",
    description:
      "Para montañeros que practican principalmente en Andalucía, Ceuta y Melilla",
...
export const LICENSE_TYPES: LicenseType[] = [
  ...
  // ============================================================
  {
    ...
    coverage:
      "Excursiones, Senderismo, Escalada, Vías Ferratas, Alpinismo, Esquí de Montaña, Descenso de Barrancos, Acampadas Alpinísticas, Raquetas de Nieve, Marcha Nórdica, Travesías y Carreras por Montaña",
    popular: false,
  },
  {
    id: "a_plus",
    ...
    coverage:
      "Todo lo de A + BTT, Espeleología y Esquí Nórdico (no competitivos)",
  ...
  // ============================================================
  {
    ...
    coverage:
      "Cobertura autonómica ampliada a toda España: Excursiones, Senderismo, Escalada, Vías Ferratas, Alpinismo, Esquí de Montaña, Descenso de Barrancos, Acampadas Alpinísticas, Raquetas de Nieve, Marcha Nórdica, Travesías y Carreras por Montaña. NO válida para competiciones, actividades o formaciones FEDME ni para descuentos en refugios del convenio de reciprocidad.",
    popular: false,
  },
  {
    id: "a_nac_plus",
    ...
    coverage:
      "Todo lo de A NAC + BTT, Espeleología y Esquí Nórdico con cobertura en toda España NO COMPETITIVA. Válida solo para competiciones de ámbito autonómico. NO válida para FEDME ni para descuentos en refugios del convenio de reciprocidad.",
  ...
  },
  {
    ...
    coverage:
      "Todo lo de B + BTT, Espeleología y Esquí Nórdico (no competitivos)",
  ...
  // ============================================================
  {
    ...
    coverage:
      "Cobertura completa en Europa incluyendo BTT, Espeleología y Esquí Nórdico (no competitivos)",
    popular: false,
  },
];
...
export function filterLicenses(
  ...
  return LICENSE_TYPES.filter((license) => {
    ...
    if (!wantsExtras && license.includesExtras && territory !== "european")
      return false;

    // Si quiere extras, solo mostrar con extras
    if (wantsExtras && !license.includesExtras && territory !== "none")
      return false;
...
export function getTerritoryByLicenseId(
  licenseId: string,
